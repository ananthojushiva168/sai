...
//         fetch('https://saicomplaintregistration.vercel.app/changePassword', request)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    changePasswordBtn.addEventListener('click', function(event) {
        ...
        if (!passwordRegex.test(newPassword)) {
            displayErrorMessage('Password must be at least 8 characters long, contain at least one capital letter, one number, and one special character');
            return;
        }
