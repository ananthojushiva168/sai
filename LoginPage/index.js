  ...
  loginButton.addEventListener('click', () => {
      ...
      .then(data => {
          ...
          if (data.user === 'MainAdmin') {
              ...
              console.log('Redirecting to Admin Dashboard');
              const url = `http://127.0.0.1:5500/AdminDashboard/admin.html?name=${encodeURIComponent(data.name)}&email=${encodeURIComponent(data.email)}`
...
// 
            ...
            //   let url = `StudentDashboard/student.html?name=${encodeURIComponent(data.name)}&email=${encodeURIComponent(data.email)}`
              const url = `http://127.0.0.1:5500/StudentDashboard/student.html?name=${encodeURIComponent(data.name)}&email=${encodeURIComponent(data.email)}`;
  ...
  const forgotPasswordButton = document.querySelector('.forgot-password');
  forgotPasswordButton.addEventListener('click', () => {
    const url = `http://127.0.0.1:5500/forgotPassword.html`;
